filename = 'C:\Users\rigas\Desktop\Παλμογραφηματα\ERC_12\NewFile1.csv';  
...
hold on;
V_ref = 100 * (time < 150) + 160 * (time >= 150 & time<=835) + 100 * (time>835);
% plot(time_us, 100*ones((size(time_us))), 'g-', 'LineWidth', 2.5);
